    ...
    public function read(): bool
    {
        if ($this->getMetaId()) {
            ...
            while ($row = $res->fetchRow(ilDBConstants::FETCHMODE_OBJECT)) {
                ...
                $this->setOperatingSystemName((string) $row->operating_system_name);
                $this->setOperatingSystemMinimumVersion((string) $row->os_min_version);
                $this->setOperatingSystemMaximumVersion((string) $row->os_max_version);
                $this->setBrowserName((string) $row->browser_name);
                $this->setBrowserMinimumVersion((string) $row->browser_minimum_version);
                $this->setBrowserMaximumVersion((string) $row->browser_maximum_version);
