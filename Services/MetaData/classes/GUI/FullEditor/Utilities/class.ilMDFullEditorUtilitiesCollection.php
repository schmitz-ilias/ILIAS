 ...
 */
class ilMDFullEditorUtilitiesCollection
{
    ...
    public function __construct(
        ...
        $this->prop_provider = new ilMDFullEditorPropertiesProvider(
    ...
    public function propertiesProvider(): ilMDFullEditorPropertiesProvider
    {
