 ...
 */
class ilMDLOMEditorGUIQuirkDictionary implements ilMDDictionary
{
    public const MD_SCHEMA = 'LOM v 1.0';

    protected ilMDTagFactory $tag_factory;
    protected ilMDLOMEditorGUIQuirkStructure $structure;
    ...
    protected function initStructureWithTags(): ilMDLOMEditorGUIQuirkStructure
    {
        $structure = new ilMDLOMEditorGUIQuirkStructure();
    ...
    ): ilMDLOMEditorGUIQuirkStructure {
        $structure
    ...
    protected function getNotDeletableTag(int $index): ilMDEditorGUIQuirkTag
    {
        return $this
            ->getTagBuilder()
            ->addNotDeletable(1)
    ...
    protected function getTagBuilder(): ilMDEditorGUIQuirkTagBuilder
    {
        return $this->tag_factory->editorGUIQuirkTag();
    }
}
